            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              <Card className="hover:shadow-xl transition-all border-2 relative overflow-hidden">
                ...
                <CardHeader className="pt-6 sm:pt-8">
                  ...
                  <div className="mt-4 sm:mt-6">
                    <span className="sm:text-5xl font-bold text-primary text-3xl">Бесплатно</span>
                  </div>
                </CardHeader>
                <CardContent>
              ...
              <Card className="border-primary border-4 hover:shadow-2xl transition-all relative sm:col-span-2 lg:col-span-1">
                ...
                <CardHeader className="pt-6 sm:pt-8">
                  ...
                  <div className="mt-4 sm:mt-6">
                    <span className="sm:text-5xl font-bold text-primary text-3xl">16 000₽</span>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              <Card className="hover:shadow-xl transition-all border-2 relative overflow-hidden">
                ...
                <CardHeader className="pt-8">
                  ...
                  <div className="mt-6">
                    <span className="font-bold text-primary text-3xl">Бесплатно</span>
                  </div>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-4 mb-8">
              ...
              <Card className="hover:shadow-xl transition-all border-2 relative overflow-hidden">
                ...
                <CardHeader className="pt-8">
                  ...
                  <div className="mt-6">
                    <span className="font-bold text-3xl">2600₽</span>
              ...
              <Card className="border-primary border-4 hover:shadow-2xl transition-all relative">
                ...
                <CardHeader className="pt-8">
                  ...
                  <div className="mt-6">
                    <span className="font-bold text-primary text-3xl">20 000₽</span>
